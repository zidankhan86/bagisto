...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Copyright 2010 - :current_year, Bagisto Software (in Indien registriert). Alle Rechte vorbehalten.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Copyright 2010 - :current_year, Bagisto Software (eingetragen in Indien). Alle Rechte vorbehalten.',
                'locale'                 => 'Sprache',
