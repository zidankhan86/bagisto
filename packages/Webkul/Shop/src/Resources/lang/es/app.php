...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Derechos de autor 2010 - :current_year, Bagisto Software (Registrado en India). Todos los derechos reservados.',
        ...
        'reset-password' => [
            ...
            'footer'           => '© Derechos de autor 2010 - :current_year, Bagisto Software (Registrada en India). Todos los derechos reservados.',
            'password'         => 'Contraseña',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Derechos de autor 2010 - :current_year, Bagisto Software (registrada en India). Todos los derechos reservados.',
                'locale'                 => 'Idioma',
